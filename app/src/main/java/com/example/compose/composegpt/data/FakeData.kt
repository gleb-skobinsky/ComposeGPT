...
package com.example.compose.composegpt.data

import com.example.compose.composegpt.R
import com.example.compose.composegpt.conversation.ConversationUiState
import com.example.compose.composegpt.conversation.Message
import com.example.compose.composegpt.data.EMOJIS.EMOJI_CLOUDS
import com.example.compose.composegpt.data.EMOJIS.EMOJI_FLAMINGO
import com.example.compose.composegpt.data.EMOJIS.EMOJI_MELTING
import com.example.compose.composegpt.data.EMOJIS.EMOJI_PINK_HEART
import com.example.compose.composegpt.data.EMOJIS.EMOJI_POINTS
import com.example.compose.composegpt.profile.ProfileScreenState
